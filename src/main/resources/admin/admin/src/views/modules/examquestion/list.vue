    ...
    <template v-if="!showFlag">
      <el-form :style='{"width":"250px","padding":"0 6px","margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"flexDirection":"column","display":"flex"}'>
			...
			<div :style='{"margin":"0","flexDirection":"column","display":"flex"}'>
			  <label :style='{"margin":"0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考试题目</label>
			  <el-input v-model="searchForm.questionname" placeholder="考试题目名称" clearable></el-input>
			</div>
			<el-button :style='{"border":"1px solid #97C9D6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 2px 0px #78ABC3","outline":"none","margin":"10px 0 0","color":"#78ABC3","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' round @click="search()">查询</el-button>
		</el-row>
        <el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
          <el-button :style='{"border":"1px solid #97C9D6","cursor":"pointer","padding":"0","boxShadow":"0px 2px 2px 0px #78ABC3","margin":"0 0 10px","outline":"none","color":"#78ABC3","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' type="primary" @click="addOrUpdateHandler()" round>新增</el-button>
          <el-button
		     :style='{"border":"1px solid #97C9D6","cursor":"pointer","padding":"0","boxShadow":"0px 2px 2px 0px #78ABC3","margin":"0 0 10px","outline":"none","color":"#78ABC3","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}'
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                size="small"
				:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","fontSize":"14px","height":"32px"}'
