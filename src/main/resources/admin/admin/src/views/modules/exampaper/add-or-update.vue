<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="笔试考试名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="笔试考试名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="笔试考试名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="笔试考试名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="驾校考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="驾校考试时长(分钟)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="驾校考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="驾校考试时长(分钟)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="笔试考试状态" prop="status">
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择笔试考试状态" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="笔试考试状态" prop="status">
					<el-input v-model="ruleForm.status?'启用':'禁用'" 
						placeholder="笔试考试状态" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				name: [
					{ required: true, message: '笔试考试名称不能为空', trigger: 'blur' },
				],
				time: [
					{ required: true, message: '驾校考试时长(分钟)不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
				status: [
					{ required: true, message: '笔试考试状态不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
			}
		};
