	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教龄" prop="jiaoling">
					<el-input v-model="ruleForm.jiaoling" placeholder="教龄" clearable  :readonly="ro.jiaoling"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="教龄" prop="jiaoling">
