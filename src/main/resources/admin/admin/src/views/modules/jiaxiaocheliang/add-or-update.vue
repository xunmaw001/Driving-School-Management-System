	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="车辆信息" prop="cheliangxinxi">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.cheliangxinxi" label="车辆信息" prop="cheliangxinxi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.cheliangxinxi"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.jiaolianzhanghao!=''&&json.jiaolianzhanghao && this.$storage.get("role")!="管理员"){
						this.ruleForm.jiaolianzhanghao = json.jiaolianzhanghao
						this.ro.jiaolianzhanghao = true;
					}
					if(json.jiaolianxingming!=''&&json.jiaolianxingming && this.$storage.get("role")!="管理员"){
	...
	this.ruleForm.cheliangxinxi = this.ruleForm.cheliangxinxi.replace(reg,'../../../springboot7e8wi/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
