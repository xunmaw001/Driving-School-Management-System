<template>
  <div>
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="选择笔试考试" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择笔试考试">
          <el-option
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="考试题目" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="类型" prop="type">
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="ruleForm.type!=3&&ruleForm.type!=2" label="选项" prop="options">
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
        <el-select v-model="ruleForm.answer">
          <el-option
            :label="item.text"
            :value="item.code"
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="ruleForm.type==3" label="答案" prop="answer">
        <el-input v-model="ruleForm.answer" placeholder="答案" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="分数" prop="score">
        <el-input-number v-model="ruleForm.score" :min="1" :max="100" label="分数"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="分析" prop="analysis">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="排序" prop="sequence">
      ...
      <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit">提交</el-button>
        <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">取消</el-button>
      </el-form-item>
    </el-form>
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择笔试考试", trigger: "blur" }],
        questionname: [
          { required: true, message: "考试题目内容不能为空", trigger: "blur" }
        ],
        type: [{ required: true, message: "请选择考试题目类型", trigger: "blur" }],
