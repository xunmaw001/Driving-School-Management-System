		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预约号" prop="yuyuehao">
					<el-input v-model="ruleForm.yuyuehao" placeholder="预约号" clearable  :readonly="ro.yuyuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="预约号" prop="yuyuehao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="取消原因" prop="quxiaoyuanyin">
					<el-input v-model="ruleForm.quxiaoyuanyin" placeholder="取消原因" clearable  :readonly="ro.quxiaoyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="取消原因" prop="quxiaoyuanyin">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `quxiaokaoshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.quxiaokaoshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
