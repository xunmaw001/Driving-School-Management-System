    ...
    <el-tabs tab-position="left" :style='{"boxShadow":"0 2px 4px rgba(0,0,0,.1)","padding":"12px 0 0","margin":"20px 0 40px","borderColor":"#52b646","borderRadius":"8px","background":"#f5f5f5","borderWidth":"4px","borderStyle":"dashed dotted solid double"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="学员账号" prop="xueyuanzhanghao">
            <el-input v-model="sessionForm.xueyuanzhanghao" placeholder="学员账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="学员姓名" prop="xueyuanxingming">
            <el-input v-model="sessionForm.xueyuanxingming" placeholder="学员姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="手机" prop="shouji">
            <el-input v-model="sessionForm.shouji" placeholder="手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="身份证" prop="shenfenzheng">
            <el-input v-model="sessionForm.shenfenzheng" placeholder="身份证" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="xueyuantouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="驾驶证类型" prop="jiashizhengleixing">
            <el-input v-model="sessionForm.jiashizhengleixing" placeholder="驾驶证类型" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="教练账号" prop="jiaolianzhanghao">
            <el-input v-model="sessionForm.jiaolianzhanghao" placeholder="教练账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="教练姓名" prop="jiaolianxingming">
            <el-input v-model="sessionForm.jiaolianxingming" placeholder="教练姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="教龄" prop="jiaoling">
            <el-input v-model="sessionForm.jiaoling" placeholder="教龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="jiaxiaojiaoliantouxiangHandleAvatarSuccess">
              <img :style='{"border":"1px dashed #88d67e","cursor":"pointer","boxShadow":"inset 0px 0px 48px 0px #def5db","color":"#88d67e","borderRadius":"6px","textAlign":"center","width":"200px","fontSize":"32px","lineHeight":"120px","height":"auto"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaxiaojiaolian'" label="联系电话" prop="lianxidianhua">
      ...
      <el-tab-pane label="驾校考试记录"></el-tab-pane>
...
<script>
  ...
  export default {
    ...
    created() {
      if ('xueyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'xueyuanzhanghao', null);
      }
      if ('xueyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      if ('xueyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'xueyuanxingming', null);
      }
      if ('xueyuan' == this.userTableName) {
      ...
      if ('xueyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'jiashizhengleixing', null);
      }
      if ('jiaxiaojiaolian' == this.userTableName) {
      ...
      if ('xueyuan' == this.userTableName) {
        this.$set(this.rules, 'xueyuanzhanghao', [{ required: true, message: '请输入学员账号', trigger: 'blur' }]);
      }
      if ('xueyuan' == this.userTableName) {
    ...
    methods: {
      ...
      xueyuantouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('xueyuan' == this.userTableName) {
      ...
      jiaxiaojiaoliantouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('jiaxiaojiaolian' == this.userTableName) {
            this.sessionForm.touxiang = 'upload/' + res.file;
          }
