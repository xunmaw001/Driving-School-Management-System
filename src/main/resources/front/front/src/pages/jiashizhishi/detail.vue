...
<div>
	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"20px auto 0","position":"relative"}'>
		...
		<video :style='{"border":"0","padding":"20px 20%","margin":"20px auto","outline":"none","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","display":"block","width":"100%","borderStyle":"dotted dashed solid double"}' :src="baseUrl +  detail.shipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
