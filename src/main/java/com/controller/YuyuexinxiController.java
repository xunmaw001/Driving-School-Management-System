...
public class YuyuexinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuyuexinxiEntity yuyuexinxi,
		...
		if(tableName.equals("jiaxiaojiaolian")) {
			yuyuexinxi.setJiaolianzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xueyuan")) {
			yuyuexinxi.setXueyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
